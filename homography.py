...
def get_homography():
    # Pixel coordinates
    pixel_lst = [(568 ,  304),      #1 (u1', v1') u1'=u1/w1, v1'=v1/w1
                (441 ,  257),       #2 (u2', v2') u2'=u2/w2, v2'=v2/w2
                (350 ,  223),       #3 (u3', v3') u3'=u3/w3, v3'=v3/w3
                (314 ,  210),       #4 (u4', v4') u4'=u4/w4, v4'=v4/w4
                (459 ,  380),       #5 (u5', v5') u5'=u5/w5, v5'=v5/w5
                (336 ,  307),       #6 (u6', v6') u6'=u6/w6, v6'=v6/w6
                (252 ,  260),       #7 (u7', v7') u7'=u7/w7, v7'=v7/w7
                (185 ,  387),       #8 (u8', v8') u8'=u8/w8, v8'=v8/w8
                (123 ,  311)]        #9 (u9', v9') u9'=u9/w9, v9'=v9/w9
